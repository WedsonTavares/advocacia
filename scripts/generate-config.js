...
const appConfig = {
  ...
  ADMIN_CONVERSAS_ENDPOINT: env.ADMIN_CONVERSAS_ENDPOINT || '',
  ADMIN_LOGS_ENDPOINT: env.ADMIN_LOGS_ENDPOINT || '',
  SUPABASE_URL: env.SUPABASE_URL || '',
  SUPABASE_ANON_KEY: env.SUPABASE_ANON_KEY || '',
  SUPABASE_LEADS_TABLE: env.SUPABASE_LEADS_TABLE || 'chat_leads',
  SUPABASE_CONVERSAS_TABLE: env.SUPABASE_CONVERSAS_TABLE || '',
  SUPABASE_LOGS_TABLE: env.SUPABASE_LOGS_TABLE || ''
};
